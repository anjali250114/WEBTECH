      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="course">
              <option value="BSBA" <?php echo $course == 'BSBA' ? "selected": ""; ?>>MCA</option>
              <option value="BSOA" <?php echo $course == 'BSOA' ? "selected": ""; ?>>MSC CS</option>
              <option value="BSIT" <?php echo $course == 'BSIT' ? "selected": ""; ?>>MDS</option>
              <option value="BSCS" <?php echo $course == 'BSCS' ? "selected": ""; ?>>BCA</option>
              <option value="BSCE" <?php echo $course == 'BSCE' ? "selected": ""; ?>>BSC</option>
